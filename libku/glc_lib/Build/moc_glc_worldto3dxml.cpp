...
**
** Created: Mon Feb 25 13:38:18 2013
...
static const char qt_meta_stringdata_GLC_WorldTo3dxml[] = {
    "GLC_WorldTo3dxml\0\0currentQuantum(int)\0"
};
...
const QMetaObjectExtraData GLC_WorldTo3dxml::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GLC_WorldTo3dxml::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GLC_WorldTo3dxml,
      qt_meta_data_GLC_WorldTo3dxml, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GLC_WorldTo3dxml::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GLC_WorldTo3dxml))
